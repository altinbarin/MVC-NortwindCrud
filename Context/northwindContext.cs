...
namespace ExampleContexts
{
    public partial class northwindContext : DbContext
    {
        ...
        public virtual DbSet<CwSiparisRaporlari> CwSiparisRaporlaris { get; set; } = null!;
        public virtual DbSet<Employee> Employees { get; set; } = null!;
        public virtual DbSet<EnPahaliCondiment> EnPahaliCondiments { get; set; } = null!;
        ...
        public virtual DbSet<VwCalisanBilgileri> VwCalisanBilgileris { get; set; } = null!;
        public virtual DbSet<VwCustomerOrderSummary> VwCustomerOrderSummaries { get; set; } = null!;
        public virtual DbSet<VwOrderCustomer> VwOrderCustomers { get; set; } = null!;
        public virtual DbSet<VwSiparisRaporlari> VwSiparisRaporlaris { get; set; } = null!;
        public virtual DbSet<VwSiparisTutariveAdedi> VwSiparisTutariveAdedis { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Data Source=DESKTOP-PE0VBS8;Initial Catalog=northwind;Integrated Security=True;Connect Timeout=30;Encrypt=False;Trust Server Certificate=False;Application Intent=ReadWrite;Multi Subnet Failover=False");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CwSiparisRaporlari>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("CW_SiparisRaporlari");
                ...
                entity.Property(e => e.ÇalışanAdıVeSoyadı)
                    .HasMaxLength(31)
                    .HasColumnName("Çalışan Adı ve Soyadı");
            });
            ...
            modelBuilder.Entity<EnPahaliCondiment>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("EnPahaliCondiments");
                ...
                entity.Property(e => e.TedarikçiAdı)
                    .HasMaxLength(40)
                    .HasColumnName("Tedarikçi Adı");
            ...
            modelBuilder.Entity<KritikSeviyeUrunBilgileri>(entity =>
            {
                ...
                entity.Property(e => e.BirimFiyati)
                    .HasColumnType("money")
                    .HasColumnName("Birim Fiyati");

                entity.Property(e => e.Kategori).HasMaxLength(15);

                entity.Property(e => e.MinimumSiparisAdedi).HasColumnName("Minimum Siparis Adedi");

                entity.Property(e => e.TedarikciFirma)
                    .HasMaxLength(40)
                    .HasColumnName("Tedarikci Firma");

                entity.Property(e => e.UrunAdi)
                    .HasMaxLength(40)
                    .HasColumnName("Urun Adi");
            });
            ...
            modelBuilder.Entity<VwCalisanBilgileri>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("VW_CalisanBilgileri");
            ...
            modelBuilder.Entity<VwCustomerOrderSummary>(entity =>
            {
                ...
                entity.Property(e => e.SiparişAdedi).HasColumnName("Sipariş Adedi");

                entity.Property(e => e.ToplamTutar).HasColumnName("Toplam Tutar");
            });

            modelBuilder.Entity<VwOrderCustomer>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("VW_OrderCustomer");
            ...
            modelBuilder.Entity<VwSiparisRaporlari>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("VW_SiparisRaporlari");
            ...
            modelBuilder.Entity<VwSiparisTutariveAdedi>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("VW_SiparisTutariveAdedi");
                ...
                entity.Property(e => e.SiparişSayısı).HasColumnName("Sipariş Sayısı");

                entity.Property(e => e.SiparişTutarı).HasColumnName("Sipariş Tutarı");
            });
