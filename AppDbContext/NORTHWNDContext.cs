...
namespace _10_MVC_NortwindCrud.AppDbContext
{
    public partial class NORTHWNDContext : DbContext
    {
        ...
        public virtual DbSet<Müsterisipari> Müsterisiparis { get; set; } = null!;
        public virtual DbSet<Müsterisipariss> Müsterisiparisses { get; set; } = null!;
        public virtual DbSet<Müsterisiparisss> Müsterisiparissses { get; set; } = null!;
        ...
        public virtual DbSet<Top5Condiment> Top5Condiments { get; set; } = null!;
        public virtual DbSet<ToplamSiparisBilgisi> ToplamSiparisBilgisis { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Data Source=DESKTOP-PE0VBS8;Database=northwind;Integrated Security=True;Connect Timeout=30;Encrypt=False;Trust Server Certificate=False;Application Intent=ReadWrite;Multi Subnet Failover=False");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CustomerOrderSummary>(entity =>
            {
                ...
                entity.Property(e => e.ToplamOdenenMiktar).HasColumnType("money");
            });
            ...
            modelBuilder.Entity<Müsterisipari>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("müsterisiparis");
            ...
            modelBuilder.Entity<Müsterisipariss>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("müsterisipariss");
            ...
            modelBuilder.Entity<Müsterisiparisss>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("müsterisiparisss");
            ...
            modelBuilder.Entity<Top5Condiment>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("Top5Condiments");
            ...
            modelBuilder.Entity<ToplamSiparisBilgisi>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("ToplamSiparisBilgisi");

                entity.Property(e => e.OrderId).HasColumnName("OrderID");

                entity.Property(e => e.SiparisTutari).HasColumnType("money");
            });
